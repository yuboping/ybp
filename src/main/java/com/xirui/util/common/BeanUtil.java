...
public class BeanUtil {
	...
	/**
	 * 
	 * <p>Description:将Bean数据转换为自定义的map存储数据</p>
	 * @author zhangchunmei@new4g.cn
	 * @date 2016年5月16日上午11:48:02
	 * @param params 需要转换的 map
	 * @param  
	 * @return 
	 */
	...
	/**
	 * 
	 * <p>Description:将Bean数据转换为map存储数据</p>
	 * @author zhangchunmei@new4g.cn
	 * @date 2016年5月16日上午11:48:02
	 * @param params 需要转换的 map
	 * @param  
	...
	/**
	 * 
	 * <p>Description:将list map数据转换为Bean存储数据</p>
	 * @author zhangchunmei@new4g.cn
	 * @date 2016年5月16日上午11:48:02
	 * @param params 需要转换的 map
	 * @param  
	...
	public static void mapToBean(Map<String, Object> params,Object bean) {
		try {
			ConvertUtils.register(new Converter() { // 鏃ユ湡绫诲瀷杞崲鍣?
