...
<body>
	...
	<main> <a class="buy_now_btn_wechat" href="javascript:void(0);"  > 
...
<script type="text/javascript">
    ...
    function buyIns() {
    	...
    	$.ajax({
			type : "post",
			url : "${ctxPath}/wx/goBuy.do", 
			async : false,
			data : {
				openId : "1"
			} ,
			success : function(data) {
				window.location.href = "http://www.epicc.com.cn/wap/groupBuy/groupbuy/tg?id=12009702051&riskcode=JBD_B";
			}
		});	
    }
